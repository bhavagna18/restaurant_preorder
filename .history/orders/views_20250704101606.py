...
from twilio.rest import Client  # ✅ Place this at the top of views.py

def send_sms(to_number, name, order_id, ready=False):
    from twilio.rest import Client

    account_sid = 'REDACTED_SID'
    auth_token = '4b3962cff282e4d9c1f8242f62de946a'
    twilio_number = 'REDACTED_NUMBER'
